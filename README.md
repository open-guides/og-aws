...
-   If you want to use a self-obtained SSL certificate with Cloudfront. Make sure it's 2048 bits since Cloudfront only support 2048 bits SSL certificates. [Ongoing discussion](https://forums.aws.amazon.com/thread.jspa?threadID=148783)
