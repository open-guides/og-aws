...
-	**Security auditing:**
	...
	-	[Scout2](https://github.com/nccgroup/Scout2) is an open source tool that uses AWS API's to assess an environment's security posture. Scout2 is stable and actively maintained.
