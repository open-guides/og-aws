...
-	DynamoDB does not allow an empty string as a valid attribute value. Main work around is to use a substitute value instead of having the field empty. This issue has been raised on the [DynamoDB Forums](https://forums.aws.amazon.com/thread.jspa?threadID=90137).
