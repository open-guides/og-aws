...
-	**Tools:**
  ...
  - Use the open-source [Auto-Tag](https://github.com/GorillaStack/auto-tag) tool to Automatically tag AWS resources on creation with the ARN of the user/role that created them. Very useful to ensure some level of cost allocation.
  - Use the open-source [Retro-Tag](https://github.com/GorillaStack/retro-tag) tool to tag pre-existing AWS resources with the ARN of the user/role that created them.
-	**Third-party services:** Several companies offer services designed to help you gain insights into expenses or lower your AWS bill, such as [OpsClarity](http://www.opsclarity.com/), [Cloudability](https://www.cloudability.com/), [CloudHealth Technologies](https://www.cloudhealthtech.com/), [ParkMyCloud](http://www.parkmycloud.com/) and [GorillaStack](https://www.gorillastack.com). Some of these charge a percentage of your bill, which may be expensive. See the [market landscape](#tools-and-services-market-landscape).
