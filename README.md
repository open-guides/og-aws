...
-	**CloudFormation** offers mechanisms to create and manage entire configurations of many types of AWS resources, using a templating language based on JSON (🔹and YAML since Q3 2016). 
