...
-	**AZ naming** differs from one customer account to the next. Your “us-west-1a” is not the same as another customer’s “us-west-1a”. This can also be a gotcha if you have multiple AWS accounts. You can run “aws ec2 describe-availability-zones --region $REGION“ to list AZs available to you.
