...
-	**IAM Reference:** [an interactive reference for all IAM actions, effects, and resources](https://iam.cloudonaut.io/) great to have open while writing new or trying to understand existing IAM policies.
