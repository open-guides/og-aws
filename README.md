...
* 🔸By default, CloudWatch metric resolution is 1 minute. If you send multiple vaules of a metric within the same minute, they will be aggregated into minimum, maximum, average and total (sum) per minute.
