...
-	❗**Don't check in AWS credentials or secrets to a git repository**  There are bots that scan GitHub looking for AWS credentials.  Use scripts or tools, such as the one from AWSLabs called [git-secrets](https://github.com/awslabs/git-secrets) to prevent anyone on your team from checking in sensitive information to your git repos. 
