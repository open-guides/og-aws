...
| Load balancer                 | CLB/ALB                                                                      | Load Balancing               | GFE             |            |                                   | nginx, HAProxy, Apache Traffic Server                      |
...
-	**IPv4 vs IPv6:** For a long time S3 only supported IPv4 at the default endpoint `https://BUCKET.s3.amazonaws.com`. However, [as of Aug 11, 2016](https://aws.amazon.com/blogs/aws/now-available-ipv6-support-for-amazon-s3/) it now supports both IPv4 & IPv6! To use both, you have to enable *dualstack* either in your preferred api client or by directly using this url scheme `https://BUCKET.s3.dualstack.REGION.amazonaws.com`.
